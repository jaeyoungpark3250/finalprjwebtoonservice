    ...
    <div>
        ...
        >
            <v-row>
                <v-list-item class="d-flex">
                    ...
                    <h1 class="align-self-center ml-3">History</h1>
        ...
        <v-col style="margin-bottom:40px;">
            <div class="text-center">
                ...
                >
                    <HistoryserviceHistory :offline="offline" class="video-card" :isNew="true" :editMode="true" v-model="newValue" 
        ...
        <v-row>
            <HistoryserviceHistory :offline="offline" class="video-card" v-for="(value, index) in values" v-model="values[index]" v-bind:key="index" @delete="remove"/>
        </v-row>
    </div>
</template>
...
<script>
    ...
    import HistoryserviceHistory from './../HistoryserviceHistory.vue';
