    ...
    <div>
        ...
        <v-col style="margin-bottom:40px;">
            <div class="text-center">
                ...
                >
                    <PurchaseservicePurchase :offline="offline" class="video-card" :isNew="true" :editMode="true" v-model="newValue" 
        ...
        <v-row>
            <PurchaseservicePurchase :offline="offline" class="video-card" v-for="(value, index) in values" v-model="values[index]" v-bind:key="index" @delete="remove"/>
        </v-row>
    </div>
</template>
...
<script>
    ...
    import PurchaseservicePurchase from './../PurchaseservicePurchase.vue';

    export default {
        name: 'PurchaseservicePurchaseManager',
        components: {
            PurchaseservicePurchase,
        },
        props: {
            offline: Boolean
        },
