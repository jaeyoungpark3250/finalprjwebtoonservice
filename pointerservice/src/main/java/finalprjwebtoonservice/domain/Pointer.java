...
import finalprjwebtoonservice.domain.Joind;
import finalprjwebtoonservice.domain.Withdrawed;
import finalprjwebtoonservice.domain.Increased;
import finalprjwebtoonservice.domain.DecreasedComplete;
import finalprjwebtoonservice.PointerserviceApplication;
...
public class Pointer  {
    ...
    public void join(){
        ...
        finalprjwebtoonservice.external.PointerQuery pointerQuery = new finalprjwebtoonservice.external.PointerQuery();
        PointerApplication.applicationContext
            .getBean(finalprjwebtoonservice.external.Service.class)
            .( pointerQuery);
    }
